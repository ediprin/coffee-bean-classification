...
from .prepare_synthetic_domains import DOMAIN_NAMES, prepare_synthetic_domains


MODEL_CONFIGS = {
    "M0": Path("configs/M0_mobilenetv3_gap_source.yaml"),
    "M1": Path("configs/M1_mobilenetv3_hbp_source.yaml"),
    "M2": Path("configs/M2_mobilenetv3_gap_mmd.yaml"),
    "M3": Path("configs/M3_mobilenetv3_gap_lmmd.yaml"),
    "M4": Path("configs/M4_mobilenetv3_hbp_dann.yaml"),
    "M5": Path("configs/M5_mobilenetv3_hbp_lmmd.yaml"),
}
