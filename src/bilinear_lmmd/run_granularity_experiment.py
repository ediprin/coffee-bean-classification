...
from .prepare_coarse_coffee17 import prepare_coarse_coffee17


MODEL_CONFIGS = {
    "GF0": Path("configs/M0_mobilenetv3_gap_source.yaml"),
    "GF0b": Path("configs/M0b_mobilenetv3_bilinear_source.yaml"),
    "GF1": Path("configs/M1_mobilenetv3_hbp_source.yaml"),
    "GC0": Path("configs/GC0_mobilenetv3_gap_coarse9_source.yaml"),
    "GC0b": Path("configs/GC0b_mobilenetv3_bilinear_coarse9_source.yaml"),
    "GC1": Path("configs/GC1_mobilenetv3_hbp_coarse9_source.yaml"),
}
