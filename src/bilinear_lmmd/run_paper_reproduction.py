...
from .prepare_paper_protocol import prepare_paper_protocol


MODEL_CONFIGS = {
    "P0": Path("configs/P0_paper_mobilenetv3_gap_ce.yaml"),
    "P1": Path("configs/P1_paper_mobilenetv3_hbp_ce.yaml"),
}
