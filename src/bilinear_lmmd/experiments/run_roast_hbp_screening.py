...
from bilinear_lmmd.data.preparation.prepare_roast_coffee import prepare_roast_coffee


MODEL_CONFIGS = {
    "R0": Path("configs/roast/R0_roast_mobilenetv3_gap_source.yaml"),
    "R1": Path("configs/roast/R1_roast_mobilenetv3_hbp_source.yaml"),
}
