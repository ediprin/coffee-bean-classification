...
from bilinear_lmmd.reporting.compare_reports import compare
from bilinear_lmmd.core.config import load_config
from bilinear_lmmd.reporting.merge_oof import merge_oof


MODEL_CONFIGS = {
    "M0": Path("configs/coffee17/M0_mobilenetv3_gap_source.yaml"),
    "M0b": Path("configs/coffee17/M0b_mobilenetv3_bilinear_source.yaml"),
...
def run_grouped_cv(
    ...
    if missing:
        raise FileNotFoundError(
            ...
            + "\n- ".join(missing)
            + "\nJalankan bilinear_lmmd.data.preparation.prepare_grouped_folds terlebih dahulu."
        )
