...
from bilinear_lmmd.data.preparation.prepare_cbd_multiclassify import EXPECTED_CLASSES, prepare_cbd_multiclassify


MODEL_CONFIGS = {
    "CBD0": Path("configs/cbd/CBD0_mobilenetv3_gap_source.yaml"),
    "CBD1": Path("configs/cbd/CBD1_mobilenetv3_hbp_source.yaml"),
    "CBD2": Path("configs/cbd/CBD2_mobilenetv3_gap_balanced_softmax.yaml"),
    "CBD3": Path("configs/cbd/CBD3_mobilenetv3_hbp_balanced_softmax.yaml"),
}
COMPARISONS = (
