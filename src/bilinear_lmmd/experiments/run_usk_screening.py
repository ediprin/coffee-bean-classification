...
from bilinear_lmmd.data.preparation.prepare_usk_coffee import prepare_usk_coffee


MODEL_CONFIGS = {
    "U0": Path("configs/usk/U0_usk_resnet18_gap_source.yaml"),
    "U1": Path("configs/usk/U1_usk_mobilenetv2_gap_source.yaml"),
    "U2": Path("configs/usk/U2_usk_mobilenetv3_gap_source.yaml"),
    "U3": Path("configs/usk/U3_usk_mobilenetv3_hbp_source.yaml"),
}
STAGES = {
    "paper": ["U0", "U1"],
    "quick": ["U1", "U2", "U3"],
