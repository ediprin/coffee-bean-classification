...
MODEL_CONFIGS = {
    "M1c": Path("configs/coffee17/M1c_mobilenetv3_hbp_mlp_source.yaml"),
    "M1f": Path("configs/coffee17/M1f_mobilenetv3_gap_hbp_fusion_source.yaml"),
    "M1rc": Path("configs/coffee17/M1rc_mobilenetv3_hbp_residual_control_source.yaml"),
    "M1r": Path("configs/coffee17/M1r_mobilenetv3_gap_hbp_residual_source.yaml"),
}
