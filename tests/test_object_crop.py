...
from bilinear_lmmd.data import ObjectCentricCrop, _transforms
...
def test_object_crop_configs_preserve_model_factorial():
    gap = load_config("configs/O0_mobilenetv3_gap_object_crop_source.yaml")
    hbp = load_config("configs/O1_mobilenetv3_hbp_object_crop_source.yaml")
