...
from bilinear_lmmd.modeling.losses import NonTargetExpertDiversityLoss
from bilinear_lmmd.engine.train import branch_gradient_cosine, supervised_objective
...
@pytest.mark.parametrize(
    ...
    [
        ("configs/coffee17/A2_mobilenetv3_gap_224_arcface_source.yaml", "gap", "arcface", 224),
        ("configs/coffee17/A3_mobilenetv3_hbp_224_arcface_source.yaml", "hbp", "arcface", 224),
        ("configs/coffee17/F0_mobilenetv3_gap_320_ce_source.yaml", "gap", "linear", 320),
        ("configs/coffee17/F1_mobilenetv3_hbp_320_ce_source.yaml", "hbp", "linear", 320),
        ("configs/coffee17/F2_mobilenetv3_gap_320_arcface_source.yaml", "gap", "arcface", 320),
        ("configs/coffee17/F3_mobilenetv3_hbp_320_arcface_source.yaml", "hbp", "arcface", 320),
    ],
)
...
def test_m0b_and_hbp_have_matched_embedding_classifier_and_capacity():
    bilinear_cfg = load_config("configs/coffee17/M0b_mobilenetv3_bilinear_source.yaml")
    hbp_cfg = load_config("configs/coffee17/M1_mobilenetv3_hbp_source.yaml")
...
def test_sp_hbp_config_is_controlled_against_hbp():
    baseline_cfg = load_config("configs/coffee17/M1_mobilenetv3_hbp_source.yaml")
    candidate_cfg = load_config("configs/coffee17/M1s_mobilenetv3_sp_hbp_source.yaml")
...
def test_hierarchical_config_is_controlled_against_hbp():
    baseline = load_config("configs/coffee17/M1_mobilenetv3_hbp_source.yaml")
    candidate = load_config("configs/coffee17/H1_mobilenetv3_hbp_hierarchical_source.yaml")
...
def test_sppf_attention_gap_config_is_controlled_against_gap():
    ...
    candidate = load_config(
        "configs/coffee17/S0_mobilenetv3_sppf_attention_gap_source.yaml"
    )
...
def test_sppf_attention_hbp_config_is_controlled_against_hbp():
    baseline = load_config("configs/coffee17/M1_mobilenetv3_hbp_source.yaml")
    candidate = load_config(
        "configs/coffee17/S1_mobilenetv3_sppf_attention_hbp_source.yaml"
    )
...
def test_ema_hbp_config_changes_only_ema_training_settings():
    baseline = load_config("configs/coffee17/M1_mobilenetv3_hbp_source.yaml")
    candidate = load_config("configs/coffee17/M1e_mobilenetv3_hbp_ema_source.yaml")
...
def test_capacity_control_matches_sppf_parameters_and_core_initialization():
    ...
    control_cfg = load_config(
        "configs/coffee17/C1_mobilenetv3_capacity_residual_hbp_source.yaml"
    )
...
def test_decoupled_configs_change_only_the_fusion_strategy():
    fixed = load_config(
        "configs/coffee17/D1_mobilenetv3_decoupled_gap_hbp_fixed_source.yaml"
    )
    learned = load_config(
        "configs/coffee17/D2_mobilenetv3_decoupled_gap_hbp_learned_source.yaml"
    )
...
def test_cbd_decoupled_configs_match_cbd_protocol_and_fusion_control():
    fixed = load_config(
        "configs/cbd/CBDD1_mobilenetv3_decoupled_gap_hbp_fixed_source.yaml"
    )
    learned = load_config(
        "configs/cbd/CBDD2_mobilenetv3_decoupled_gap_hbp_learned_source.yaml"
    )
...
def test_hbp_moe_config_is_controlled_against_hbp():
    baseline = load_config("configs/coffee17/M1_mobilenetv3_hbp_source.yaml")
    candidate = load_config("configs/coffee17/E1_mobilenetv3_hbp_local_moe_source.yaml")
...
def test_hbp_mlp_and_gap_hbp_fusion_have_matched_capacity():
    control_cfg = load_config("configs/coffee17/M1c_mobilenetv3_hbp_mlp_source.yaml")
    fusion_cfg = load_config("configs/coffee17/M1f_mobilenetv3_gap_hbp_fusion_source.yaml")
...
def test_residual_control_and_fusion_have_matched_capacity():
    control_cfg = load_config(
        "configs/coffee17/M1rc_mobilenetv3_hbp_residual_control_source.yaml"
    )
    fusion_cfg = load_config(
        "configs/coffee17/M1r_mobilenetv3_gap_hbp_residual_source.yaml"
    )
    control_cfg["model"]["pretrained"] = False
    fusion_cfg["model"]["pretrained"] = False
    control = build_model(control_cfg["model"])
...
@pytest.mark.parametrize(
    "config_path",
    [
        "configs/coffee17/M0a_mobilenetv3_gap_fixed_cbam_source.yaml",
        "configs/coffee17/M0lgf_mobilenetv3_gap_lgf_cbam_source.yaml",
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("configs/usk/U0_usk_resnet18_gap_source.yaml", "resnet18", "gap"),
        ("configs/usk/U1_usk_mobilenetv2_gap_source.yaml", "mobilenetv2_100", "gap"),
        ("configs/usk/U2_usk_mobilenetv3_gap_source.yaml", "mobilenetv3_large_100", "gap"),
        ("configs/usk/U3_usk_mobilenetv3_hbp_source.yaml", "mobilenetv3_large_100", "hbp"),
    ],
)
...
@pytest.mark.parametrize(
    ("config_path", "head"),
    [
        ("configs/roast/R0_roast_mobilenetv3_gap_source.yaml", "gap"),
        ("configs/roast/R1_roast_mobilenetv3_hbp_source.yaml", "hbp"),
    ],
)
...
def test_cbd_capacity_control_matches_decoupled_parameter_count():
    control = load_config(
        "configs/cbd/CBDC1_mobilenetv3_capacity_residual_hbp_source.yaml"
    )
    candidate = load_config(
        "configs/cbd/CBDD2_mobilenetv3_decoupled_gap_hbp_learned_source.yaml"
    )
