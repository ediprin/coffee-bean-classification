...
from bilinear_lmmd.experiments.run_granularity_experiment import _paired_granularity_effect
from bilinear_lmmd.experiments.run_granularity_bootstrap import run_granularity_bootstrap
...
def test_coarse_configs_match_fine_head_capacity_except_class_count():
    pairs = (
        ("configs/coffee17/M0_mobilenetv3_gap_source.yaml", "configs/granularity/GC0_mobilenetv3_gap_coarse9_source.yaml"),
        ("configs/coffee17/M0b_mobilenetv3_bilinear_source.yaml", "configs/granularity/GC0b_mobilenetv3_bilinear_coarse9_source.yaml"),
        ("configs/coffee17/M1_mobilenetv3_hbp_source.yaml", "configs/granularity/GC1_mobilenetv3_hbp_coarse9_source.yaml"),
    )
...
def test_granularity_models_build_with_expected_output_dimensions():
    expected = {
        "configs/granularity/GC0_mobilenetv3_gap_coarse9_source.yaml": 960,
        "configs/granularity/GC0b_mobilenetv3_bilinear_coarse9_source.yaml": 1536,
        "configs/granularity/GC1_mobilenetv3_hbp_coarse9_source.yaml": 1536,
    }
